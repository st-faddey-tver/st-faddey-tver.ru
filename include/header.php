<div class="top" id="top" style="background-image: url(<?=APPLICATION ?>/images/shapka_zima.jpg); background-position-x: center; background-position-y: top; background-size: cover;">
    <div class="container" style="margin-bottom: 0;">
        <div class="header">
            <a href="<?=APPLICATION ?>/"><img src="<?=APPLICATION ?>/images/header_prozrachny.png?date=20220316" class="img-fluid d-none d-md-block" /></a>
            ...
            <div class="d-flex d-md-none row">
                ...
                <div class="col-8 pt-2">
                    <a href="<?=APPLICATION ?>/"><img src="<?=APPLICATION ?>/images/header_slav_transparent.png?date=20220316" class="img-fluid" /></a>
                </div>
            </div>
