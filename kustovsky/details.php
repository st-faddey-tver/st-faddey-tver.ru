            ...
            <div class="content bigfont">
                ...
                <div class="row small">
                    <div class="col-4 text-left">
                        ...
                        <div class="news_name"><a href="<?=APPLICATION ?>/ustav/<?=$next_shortname ?>" title="<?=$next_name ?>" data-toggle="tooltip" data-placement="right"><i class="fas fa-arrow-left"></i></a></div>
                        <?php endif; ?>
                    </div>
                    <div class="col-4 text-center">
                        <div class="news_name">
                            <a href="<?=APPLICATION ?>/ustav/">Видеолекции Е. С. Кустовского</a>
                        </div>
                    </div>
                    <div class="col-4 text-right">
                        <?php if(!empty($previous_shortname)): ?>
                        <div class="news_name"><a href="<?=APPLICATION ?>/ustav/<?=$previous_shortname ?>" title="<?=$previous_name ?>" data-toggle="tooltip" data-placement="left"><i class="fas fa-arrow-right"></i></a></div>
                        <?php endif; ?>
                    </div>
                </div>
                <hr />
