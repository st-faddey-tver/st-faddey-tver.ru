...
if(null !== filter_input(INPUT_POST, 'image_section_delete_submit')) {
    $id = filter_input(INPUT_POST, 'id');
    $sql = "delete from image_section where id=$id";
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form method="post">
                ...
                <button type="submit" id="image_section_delete_submit" name="image_section_delete_submit" class="btn btn-outline-danger"><i class="fas fa-trash-alt"></i>&nbsp;Удалить</button>
            </form>
        </div>
        <?php
