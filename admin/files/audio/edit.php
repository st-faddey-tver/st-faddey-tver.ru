...
if(null !== filter_input(INPUT_POST, 'audio_section_edit_submit')) {
    ...
    if($form_valid) {
        ...
        $sql = "update audio_section set name='$name' where id=$id";
        $error_message = (new Executer($sql))->error;
        
        if(empty($error_message)) {
            header('Location: '.APPLICATION."/admin/files/audio/details.php".BuildQuery('id', $id));
        }
    }
}
...
$sql = "select name from audio_section where id=$id";
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="<?=APPLICATION ?>/admin/files/audio/details.php<?= BuildQuery("id", $id) ?>"><?=$name ?></a></li>
            ...
            <div class="row">
                <div class="col-6">
                    <form method="post">
                        ...
                        <div class="form-group">
                            <button type="submit" id="audio_section_edit_submit" name="audio_section_edit_submit" class="btn btn-outline-dark"><i class="fas fa-save"></i>&nbsp;Сохранить</button>
                        </div>
                    </form>
                </div>
            </div>
