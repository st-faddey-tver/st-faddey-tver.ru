...
if(null !== filter_input(INPUT_POST, 'document_section_delete_submit')) {
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form method="post">
                ...
                <button type="submit" id="document_section_delete_submit" name="document_section_delete_submit" class="btn btn-outline-danger"><i class="fas fa-trash-alt"></i>&nbsp;Удалить</button>
            </form>
        </div>
        <?php
