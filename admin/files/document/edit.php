...
if(null !== filter_input(INPUT_POST, 'document_section_edit_submit')) {
    ...
    if($form_valid) {
        ...
        $sql = "update document_section set name='$name' where id=$id";        echo $sql;
        $error_message = (new Executer($sql))->error;
        
        if(empty($error_message)) {
            header('Location: '.APPLICATION."/admin/files/document/details.php".BuildQuery('id', $id));
        }
    }
}
...
$sql = "select name from document_section where id=$id";
            ...
            <div class="row">
                <div class="col-6">
                    <form method="post">
                        ...
                        <div class="form-group">
                            <button type="submit" id="document_section_edit_submit" name="document_section_edit_submit" class="btn btn-outline-dark"><i class="fas fa-save"></i>&nbsp;Сохранить</button>
                        </div>
                    </form>
                </div>
            </div>
