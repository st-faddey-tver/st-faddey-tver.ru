...
if(empty($id)) {
    header('Location: '.APPLICATION."/admin/mediacenter/");
}
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between mb-2">
                ...
                <div class="p-1">
                    ...
                    ?>
                    <div class="btn-group">
                        <a href="<?=APPLICATION ?>/admin/mediacenter/" class="btn btn-outline-dark" title="К списку" data-toggle="tooltip"><i class="fas fa-undo-alt"></i></a>
