...
if(null !== filter_input(INPUT_POST, 'theater_create_submit')) {
    ...
    if($form_valid) {
        ...
        if(empty($error_message)) {
            header('Location: '.APPLICATION."/admin/theater/details.php". BuildQuery("id", $insert_id));
        }
    }
}
?>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between mb-2">
                ...
                <div class="p-1">
                    <a href="<?=APPLICATION ?>/admin/theater/" class="btn btn-outline-dark"><i class="fas fa-undo-alt"></i>&nbsp;Отмена</a>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-8">
                    <form method="post">
                        ...
                        <div class="form-group d-flex justify-content-between mb-auto">
                            <div class="p-1">
                                <button type="submit" id="theater_create_submit" name="theater_create_submit" class="btn btn-outline-dark"><i class="fas fa-plus"></i>&nbsp;Создать</button>
                            </div>
                            <div class="p-1">
