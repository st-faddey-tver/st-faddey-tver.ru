...
if(null !== filter_input(INPUT_POST, 'delete_theater_submit')) {
    ...
    if(empty($error_message)) {
        ...
        if(empty($error_message)) {
            ...
            if(empty($error_message)) {
                header('Location: '.APPLICATION.'/admin/theater/'.BuildQueryRemove('id'));
            }
        }
    }
}
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form method="post">
                ...
                <button type="submit" id="delete_theater_submit" name="delete_theater_submit" class="btn btn-danger">Удалить</button>
            </form>
        </div>
        <?php
