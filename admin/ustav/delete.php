...
if(null !== filter_input(INPUT_POST, 'delete_ustav_submit')) {
    ...
    if(empty($error_message)) {
        ...
        if(empty($error_message)) {
            ...
            if(empty($error_message)) {
                header('Location: '.APPLICATION.'/admin/ustav/'.BuildQueryRemove('id'));
            }
        }
    }
}
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form method="post">
                ...
                <button type="submit" id="delete_ustav_submit" name="delete_ustav_submit" class="btn btn-danger">Удалить</button>
            </form>
        </div>
        <?php
