...
if(null === filter_input(INPUT_GET, 'id')) {
    header('Location: '.APPLICATION.'/admin/ustav/');
}
...
if(null !== filter_input(INPUT_POST, 'ustav_edit_submit')) {
    ...
    if($form_valid) {
        ...
        if(empty($error_message)) {
            header('Location: '.APPLICATION."/admin/ustav/details.php".BuildQuery('id', $id));
        }
    }
}
...
<html>
    ...
    <body>
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="<?=APPLICATION ?>/admin/ustav/<?= BuildQueryRemove('id') ?>">Видеолекции Е. С. Кустовского</a></li>
            <li><a href="<?=APPLICATION ?>/admin/ustav/details.php<?= BuildQuery('id', $id) ?>"><?=$date ?></a></li>
                ...
                <div class="col-12 col-md-8">
                    <form method="post">
                        ...
                        <div class="form-group d-flex justify-content-between mb-auto">
                            <div class="p-1">
                                <button type="submit" id="ustav_edit_submit" name="ustav_edit_submit" class="btn btn-outline-dark"><i class="fas fa-save"></i>&nbsp;Сохранить</button>
                            </div>
                            <div class="p-1">
