...
<link href="<?=APPLICATION ?>/admin/css/main.css" rel="stylesheet" />
<link href="<?=APPLICATION ?>/css/fonts.css" rel="stylesheet" />
<link href="<?=APPLICATION ?>/css/sample.css" rel="stylesheet" />
